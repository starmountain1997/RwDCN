# class Vid4Backend(Backend):
#     def __init__(self, dataroot_hr='/home/usrs/gzr1997/DS/Vid4/HR', dataroot_lr='/home/usrs/gzr1997/DS/Vid4/LR'):
#         super(Vid4Backend, self).__init__(dataroot_lr=dataroot_lr, dataroot_hr=dataroot_hr)
#         self.lr_size = []
#
#     def lr_get(self, key):
