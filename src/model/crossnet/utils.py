...
class Encoder(nn.Module):
    ...
    def __init__(self, in_ch, activation='selu', init_type='w_init'):
        ...
        self.layer_f = conv_activation(in_ch, 64, kernel_size=5, stride=1, padding=2, activation=activation,
                                       init_type=init_type)
        ...
        self.conv4 = conv_activation(64, 64, kernel_size=5, stride=2, padding=2, activation=activation,
                                     init_type=init_type)
...
class UNet_decoder_2(nn.Module):
    ...
    def __init__(self, activation='selu', init_type='w_init'):
        ...
        self.final = conv_activation(64, 3, kernel_size=5, stride=1, padding=2, activation='linear',
                                     init_type=init_type)
